...
class QuestionBank {
    ...
    init() {
        ...
        questionList.append(QuestionCard(
                                ...
                                correctOption: 3, questionId: 3, note: "A alimentação natural traz diversos benefícios para o pet, como seus índices ideais de proteína animal, carboidratos não inflamatórios e de baixo índice glicêmico, além de gorduras saudáveis. Ela não leva nenhum tipo de aditivo químico, como conservantes, corantes e estabilizantes artificiais."))
        questionList.append(QuestionCard(
                                category: .naturalDiet,
        ...
        questionList.append(QuestionCard(
                                ...
                                correctOption: 1, questionId: 5, note: "Uma boa alternativa de líquido permitido para os cachorros é a água de coco. Muito popular no verão, ela é saudável, nutritiva, saborosa e ótima fonte de potássio para os bichinhos. Além disso, a água de coco contribui para melhorar a função renal dos cães.\nEntretanto, assim como o suco de frutas, ela deve ser oferecida com parcimônia: caso seja dada quente ou em grande quantidade, pode dar dor de barriga no seu cachorro. Por isso, lembre-se que é só um pouquinho!"))
        ...
        questionList.append(QuestionCard(
                                ...
                                correctOption: 1, questionId: 6, note: nil))
        questionList.append(QuestionCard(
                                category: .allowedFood,
        ...
        questionList.append(QuestionCard(
                                ...
                                correctOption: 2, questionId: 9, note: nil))
        questionList.append(QuestionCard(
                                category: .allowedFood,
                                ...
                                correctOption: 1, questionId: 10, note: nil))
        ...
        questionList.append(QuestionCard(
                                ...
                                correctOption: 0, questionId: 11, note: nil))
        questionList.append(QuestionCard(
                                category: .environmentalEnrichment,
                                ...
                                correctOption: 3, questionId: 12, note: nil))
        questionList.append(QuestionCard(
                                category: .environmentalEnrichment,
                                ...
                                correctOption: 2, questionId: 13, note: nil))
        questionList.append(QuestionCard(
                                category: .environmentalEnrichment,
                                ...
                                correctOption: 2, questionId: 14, note: nil))
        questionList.append(QuestionCard(
                                category: .environmentalEnrichment,
                                ...
                                correctOption: 3, questionId: 15, note: nil))
    }
